...
@Component({
  selector: 'app-dashboard-hfa1',
  templateUrl: './dashboard-hfa1.component.html',
  styleUrls: ['./dashboard-hfa1.component.css']
})
export class DashboardHFA1Component implements OnInit {
 ...
 {
   alert(this.Codes);
  this.router.navigate(["/statescoreDiv",{ID:this.Codes}]);
 }
  ...
  ngOnInit() {
   ...
   this.State="-Select--";
    ...
    this.backgroundColor = "#ffffff";//   this.backgroundColor ="#B3E5FC"// '#FFDD00';
    this.stateCodes = "0";
  ...
  BindOccupiedGraph(stateCode, DisttCode, cityCode, Comp, DivisionCodes) {
    ...
    this.service.GetJNNURM_Detail(stateCode,DisttCode ,cityCode ,Comp, DivisionCodes).subscribe(resultJN => {
         ...
         // alert(this.GTOccupied);
          ...
          this.GTCompletedNew_ = indianFormat(this.GTCompleted);
              ...
              if (this.demand == 0) {
                  ...
                  if (this.total_Demand_ != 0) {
                    if ((stateCode == 0 && DisttCode == 0 && cityCode == 0 && Comp == 0 && DivisionCodes == 0)) {
                      ...
                      this.ZeroDemand = "Houses Approved/Demand "  
                        + " 1  Cr";
                    }
                     ...
                     // alert('tt');
                      ...
                      this.ZeroDemand = "Houses Approved/Demand " + indianFormat(this.total_Demand1_);  //indianFormat1
                    }
                  }
                  else {
                    if (this.total_Demand_ == 0)
...
//------------------------------------------------
            ...
            this.CASanct_forReleaseN_Change =indianFormat1(this.CASanct_forReleaseNChange);
    ...
    this.service.GetStateWiseFinYrData_Div(stateCode, DivisionCodes).subscribe(result_State => { // new code
      ...
      this.service.HFACompWiseReportPMayList_Div(stateCode, DisttCode, cityCode, Comp, DivisionCodes).subscribe(result => {
        ...
        // }
          ...
          this.CA_ReleasedNw = indianFormat1(this.CA_ReleasedNw);
