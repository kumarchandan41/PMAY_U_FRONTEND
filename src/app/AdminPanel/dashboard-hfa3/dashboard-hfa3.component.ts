...
@Component({
  selector: 'app-dashboard-hfa3',
  templateUrl: './dashboard-hfa3.component.html',
  styleUrls: ['./dashboard-hfa3.component.css']
})
export class DashboardHFA3Component implements OnInit {
 ...
 // constructor(private router: Router, public service: GraphService, private modalService: NgbModal) {
  ...
  //  alert(this.lstDivision);
   ...
   if (HFAName == 'All') {
     ...
     this.service.StateListbyHFA_12();
   }
   else {
     if (checked) {
       //this.StateDetails=[];
 ...
 closeModalDialog(){
  ...
  ngOnInit() {
   ...
   this.State="-Select--";
    ...
    this.backgroundColor ="#ffffff"// '#FFDD00';
...
//    this.DivisionCodes = "0";
    ...
    this.service.StateListbyHFA_12().subscribe(result=>{
      this.StateDetails3=result;
    });
...
//            if (this.GrndTotal == 0 || this.GrndTotal == "" || this.GrndTotal == null)
  ...
  BindCompletedGraph_2(stateCode, DisttCode, cityCode, Comp, DivisionCodes) {
    this.service.GetStateWiseFinYrData_Div(stateCode, DivisionCodes).subscribe(result_State => { // new code
      //this.service.GetStateWiseFinYrData(stateCode).subscribe(result_State => { // new code
      this.Demand_Overall = result_State.Demand;
      this.Houses_Grounded_State = result_State.Grounded; //
...
//-----------------------------------------------------------
          ...
          this.Total_CostNw = indianFormat1(this.Total_CostNw);
