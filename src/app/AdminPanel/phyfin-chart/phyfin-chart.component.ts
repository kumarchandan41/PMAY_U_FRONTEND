...
@Component({
  selector: 'app-phyfin-chart',
  templateUrl: './phyfin-chart.component.html',
  styleUrls: ['./phyfin-chart.component.css']
})
export class PhyfinChartComponent implements OnInit {
  modalRef;
  StateDetails: States[];
  ...
  Lst_FinYrPayData: import("src/app/financeReport/model/chart").PMAY_DATA[];
  Lst_FinYrPayData1: import("src/app/financeReport/model/chart").PMAY_DATA[];
  //f:/AngularAll/nbo/hfawebsite/Pmayu/
  // f:/AngularAll/nbo/hfawebsite/Pmayu/
 ...
 closeModalDialog(){
  ...
  AdminPage() {
    // alert('aa');
    this.router.navigate(['/dashboard']);  //Dashboardchart  menupage
  }


  //serviceCLSSCityWiseReportPMayList
  ngOnInit() {
    this.stateCodes = "0";
...
this.service.FinYearHouses_Report(this.stateCodes, this.districtCodes, this.cityCodes).subscribe(result_Houses_Status => {
  this.LstPayData1 = result_Houses_Status;   
        ...
        this.service.GetFinYearWise_Houses_StatusReport().subscribe(result_Houses_Status => {
         this.LstPayData = result_Houses_Status;
          
        });

        this.service.PMay_FinYearWiseReport().subscribe(result_FinYear_Houses_Status => {
          this.Lst_FinYrPayData = result_FinYear_Houses_Status;
         });
          
         this.service.PMAY_FinYearHouses_Report(this.stateCodes, this.districtCodes, this.cityCodes).subscribe(result_Houses_Status1 => {
          this.Lst_FinYrPayData1 = result_Houses_Status1;   
         });
          ...
          this.NoBeneficiary_Total = result4.NoBeneficiary_Total;
             ...
             // this.Demand_Overall =indianFormat1(<number><any>this.Demand_Overall);
              ...
              if (this.demand == 0) {
                  ...
                  this.ZeroDemand = "Houses Sanctioned";
                 }
                 else {
                  if (this.total_Demand_ != 0) {
                    if ((stateCode == 0 && DisttCode == 0 && cityCode == 0 && Comp == 0 && DivisionCodes == 0)) {
                      this.total_Demand1_ = "1 Cr";
                      this.ZeroDemand = "Houses Approved v/s Demand "  
                        + " 1  Cr";
                    }
                    else if ((stateCode == 0 && DisttCode == 0 && cityCode == 0 && Comp == 0 && DivisionCodes == 0)) {
                      this.total_Demand1_ = this.Demand_Overall;
                      this.ZeroDemand = "Houses Approved v/s Demand " + indianFormat(this.total_Demand1_);// indianFormat1+ " Lakh";
                    }
                    else if ((stateCode != 0 && DisttCode == 0 && cityCode == 0)) {
                     // alert('tt');
                      this.total_Demand1_ = this.Demand_Overall;
                      // alert(this.Demand_Overall)
                      this.ZeroDemand = "Houses Approved/ Demand " + indianFormat(this.total_Demand1_) ;// indianFormat1+ " Lakh";
                    }
                      ...
                      this.ZeroDemand = "Houses Approved v/s Demand " + indianFormat(this.total_Demand1_);  //indianFormat1
                    }
                  }
                  else {
                    if (this.total_Demand_ == 0)
        ...
        // }
          ...
          let chart = new CanvasJS.Chart("caReleased", {
            ...
            data: [{
              ...
              // indexLabel: "{name}",
              dataPoints: [
                { y: this.CASanct_forRelease - this.CA_Released, name: "PendingforRelease" },
                { y: this.CA_Released, name: "CAssitReleased" },
              ]
            }]
          });
          chart.render();
          ...
          this.service.FIN_Data1617(stateCode, DisttCode, cityCode, Comp).subscribe(result2 => {
            ...
            this.service.FIN_Data1718(stateCode, DisttCode, cityCode, Comp).subscribe(result3 => {
              ...
              this.service.FIN_Data1819(stateCode, DisttCode, cityCode, Comp).subscribe(result4 => {
                ...
                else if ((Comp !=5 && Comp !=6 &&  DivisionCodes == 0 && Comp >= 0 &&  stateCode ==0 && DisttCode ==0 && cityCode ==0 ) || (Comp !=5 && Comp !=6 &&  DivisionCodes == 0 && Comp >= 0 &&  stateCode !=0 && DisttCode ==0 && cityCode ==0 ) || (Comp !=5 && Comp !=6 &&  DivisionCodes == 0 && Comp >= 0 &&  stateCode !=0 && DisttCode !=0 && cityCode ==0 )|| (Comp !=5 && Comp !=6 &&  DivisionCodes == 0 && Comp >= 0 &&  stateCode !=0 && DisttCode !=0 && cityCode !=0 ))
                // if (((Comp==0 && value ==-1)  && (stateCode ==0 && DisttCode ==0 && cityCode ==0 && value ==-1))   )
                {
                  this.HS_14_15 = result.HS_14_15;
                  this.HC_14_15 = result.HC_14_15;
              ...
              this.service.FIN_Prog1819(stateCode, DisttCode, cityCode, Comp).subscribe(result4 => {
                ...
                let chart = new CanvasJS.Chart("chartContainer2", {
                  ...
                  data: [{
                    ...
                    indexLabel: "{y}",
                    showInLegend: true,
                    legendText: "CA Approved",
                    
                    name: "Central assist Approved",
                    indexLabelPlacement: "outside",
                    indexLabelOrientation: "vertical",
