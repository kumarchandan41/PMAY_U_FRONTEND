            ...
            if (this.demand == 0) {
                ...
                if (this.total_Demand_ != 0) {
                  if ((stateCode == 0 && DisttCode == 0 && cityCode == 0 && Comp == 0 && DivisionCodes == 0)) {
                    ...
                    this.ZeroDemand = "Approved v/s Demand "  
                     + "1  cr";
                  }
                  else if ((stateCode == 0 && DisttCode == 0 && cityCode == 0 && Comp == 0 && DivisionCodes == 0)) {
                    this.total_Demand1_ = this.Demand_Overall;
                    this.ZeroDemand = "Approved v/s Demand " + indianFormat(this.total_Demand1_);// indianFormat1+ " Lakh";
                  }
                  else if ((stateCode != 0 && DisttCode == 0 && cityCode == 0)) {
                   // alert('tt');
                    this.total_Demand1_ = this.Demand_Overall;
                    // alert(this.Demand_Overall)
                    this.ZeroDemand = "Approved/ Demand " + indianFormat(this.total_Demand1_) ;// indianFormat1+ " Lakh";
                  }
                    ...
                    this.ZeroDemand = "Approved v/s Demand " + indianFormat(this.total_Demand1_);  //indianFormat1
                  }
                }
                else {
                  if (this.total_Demand_ == 0)
