...
@Component({
  selector: 'app-dashboard-hfa4',
  templateUrl: './dashboard-hfa4.component.html',
  styleUrls: ['./dashboard-hfa4.component.css']
})
export class DashboardHFA4Component implements OnInit {
