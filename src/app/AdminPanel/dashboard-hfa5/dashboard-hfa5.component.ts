...
@Component({
  selector: 'app-dashboard-hfa5',
  templateUrl: './dashboard-hfa5.component.html',
  styleUrls: ['./dashboard-hfa5.component.css']
})
export class DashboardHFA5Component implements OnInit {
...
//  lstHFACodes: import("src/app/model/charts.model").getHFACodes[];
 ...
 /**
  ...
  ngOnInit() {
    ...
    this.backgroundColor ="white"// '#FFDD00';
    this.stateCodes = "0";
