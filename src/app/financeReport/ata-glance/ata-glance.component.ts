...
@Component({
  selector: 'app-ata-glance',
  templateUrl: './ata-glance.component.html',
  styleUrls: ['./ata-glance.component.css']
})
  ...
  ngOnInit() {
    ...
    this.service.HFA_JNNURN_AtAGlanceNew(this.stateCodes, this.districtCodes, this.cityCodes, this.division).subscribe(resultJN => {
      ...
      this.service.HFA_JNNURN_AtAGlanceNew(this.stateCodes, this.districtCodes, this.cityCodes, this.division).subscribe(resultJN => {
        this.NoPApprovedJN = resultJN.NoOfprojApproved;
        this.ProjCostApp_JN = resultJN.ProjCostApproved;
      //  this.ProjCostApp_JN1 = indianFormat1(resultJN.ProjCostApproved);
        

        this.CShare_JN = resultJN.CentralShare;
      //  this.CShare_JN1 = indianFormat1(resultJN.CentralShare);


        this.CARel_JN = resultJN.CentralAssisRel;
      //  this.CARel_JN1 = indianFormat(resultJN.CentralAssisRel);

        this.HS_JN = resultJN.HousesSanctioned;
        
      //  this.HS_JN1 = indianFormat(resultJN.HousesSanctioned);

        this.Grounded_JN = resultJN.GroundedJN;

      //  this.Grounded_JN1 = indianFormat(resultJN.GroundedJN);

        

        this.Completed_JN = resultJN.CompletedJN ;//CompletedJN;
      //  this.Completed_JN1 = indianFormat(resultJN.CompletedJN) ;//CompletedJN;
        
        this.OccupiedJN = resultJN.OccupiedJN;
      //  this.OccupiedJN1 = indianFormat(resultJN.OccupiedJN);

        this.HGrnd_JN = resultJN.Grounded;
      //  this.HGrnd_JN1 = indianFormat(resultJN.Grounded);

        this.HComp_JN = resultJN.Completed;
      //  this.HComp_JN1 = indianFormat(resultJN.Completed);
        
        this.HOcc_JN = resultJN.Occupied;
     //   this.HOcc_JN1 = indianFormat1(resultJN.Occupied);
         

      //  this.NoPApprovedJN1 = indianFormat(resultJN.NoOfprojApproved);
      ...
      if(this.HOcc_JN > 0)
      {
        ...
        //  this.ProjCostRay1 = indianFormat1(result1.Project_Cost);
        ...
        //  this.HSRay1 = indianFormat1(result1.HousesSanctioned);
          
          this.HGRay = result1.Grounded;
        //  this.HGRay1 = indianFormat(result1.Grounded);
          
          this.HCRay = result1.Completed;
        //  this.HCRay1 = indianFormat(result1.Completed);
          
          this.HORay = result1.Occupied;
        //  this.HORay1 = indianFormat(result1.Occupied);
        ...
        //  this.NoOfprojRay_1 = indianFormat(result1.NoOfprojApproved);
          ...
          //  this.CAISSR1 = indianFormat1(result2.CentralAssisRel);
            
            this.HSISSR = result2.HousesSanctioned;
          //  this.HSISSR1 = indianFormat1(result2.HousesSanctioned);
            
            this.HGISSR = result2.Grounded;
          //  this.HGISSR1 = indianFormat(result2.Grounded);


            this.HCISSR = result2.Completed;
          //  this.HCISSR1 = indianFormat(result2.Completed);
            
            this.HOISSR = result2.Occupied;
          //  this.HOISSR1 = indianFormat(result2.Occupied);
           ...
           //   this.NoOfprojAHP1 = indianFormat(result3.NoOfprojApproved);
            ...
            //  this.CAAHP1 = indianFormat1(result3.CentralAssisRel);
              
              this.HSAHP = result3.HousesSanctioned;
              this.HGAHP = result3.Grounded;
            //  this.HGAHP1 = indianFormat(result3.Grounded);
              
              this.HCAHP = result3.Completed;
            //  this.HCAHP1 = indianFormat(result3.Completed);
              
              this.HOAHP = result3.Occupied;
            //  this.HOAHP1 = indianFormat(result3.Occupied);
              ...
              //  this.CABLCS1 = indianFormat1(result4.CentralAssisRel);

                
                this.HSBLCS = result4.HousesSanctioned;
                this.HGBLCS = result4.Grounded;
               // this.HGBLCS1 =indianFormat(result4.Grounded);
                
                this.HCBLCS = result4.Completed;
              //  this.HCBLCS1 = indianFormat(result4.Completed);

                this.HOBLCS = result4.Occupied;
              //  this.HOBLCS1 = indianFormat(result4.Occupied);
  ...
  getStateDetails(stateCodes) {    
    ...
    if (stateCodes == "0") {
      ...
      this.service.HFA_JNNURN_AtAGlanceNew(this.stateCodes, this.districtCodes, this.cityCodes, this.division).subscribe(result => {
        ...
        // this.CARel_JN1 = indianFormat1(result.CentralAssisRel);
