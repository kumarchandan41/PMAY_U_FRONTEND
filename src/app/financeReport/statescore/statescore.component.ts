...
@Component({
  selector: 'app-statescore',
  templateUrl: './statescore.component.html',
  styleUrls: ['./statescore.component.css'],
  providers:[DatePipe]
})
...
export class StatescoreComponent implements OnInit {
  stateCodes: string = "0";
  ...
  constructor(private router: Router,private route: ActivatedRoute, config: NgbModalConfig,private datePipe: DatePipe,
