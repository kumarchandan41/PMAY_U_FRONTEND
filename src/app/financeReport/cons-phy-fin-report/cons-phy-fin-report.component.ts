...
@Component({
  selector: 'app-cons-phy-fin-report',
  templateUrl: './cons-phy-fin-report.component.html',
  styleUrls: ['./cons-phy-fin-report.component.css']
})
...
HouseInvolved1B14: number=0;
  FundsDisbursed_in_Houses1B14 : number=0;
...
HousesOccupied61: number=0;
  ...
  display='none';
//  declaration start
// HouseInvolved11: number=0;
// FundsDisbursed_in_Houses11: number=0;
// Houses_Grounded11: number=0;
// Houses_Completed11: number=0;
// HousesOccupied11: number=0;

// HouseInvolved0: number=0;
// FundsDisbursed_in_Houses0: number=0;
// Houses_Grounded0 : number=0;
// Houses_Completed0: number=0;
// HousesOccupied0: number=0;
...
display2="none";
  ...
  HouseInvolved21_ISSR_15: number;
  FundsDisbursed_in_Houses21_ISSR_15: number;
  Houses_Grounded21_ISSR_15: number;
  Houses_Completed21_ISSR_15: number;
  HousesOccupied21_ISSR_15: number;
  HousesOccupied3_16BLCS: number;
  Houses_Completed3_16BLCS: number;
  Houses_Grounded3_16BLCS: number;
  FundsDisbursed_in_Houses3_16BLCS: number;
  HouseInvolved3_16BLCS: number;
  HousesOccupied3_16AHP: number;
  Houses_Completed3_16AHP: number;
  Houses_Grounded3_16AHP: number;
  FundsDisbursed_in_Houses3_16AHP: number;
  HouseInvolved3_16AHP: number;
  FundsDisbursed_in_Houses31_16ISSR: number;
  HousesOccupied31_16ISSR: number;
  Houses_Completed31_16ISSR: number;
  Houses_Grounded31_16ISSR: number;
  HousesOccupied4_17AHP: number;
...
//     this.BindGetStatus(this.stateCodes, this.districtCodes, this.cityCodes, this.Compid);
 ...
 // *********  
   //this.GetFilterData (this.stateCodes, this.districtCodes, this.cityCodes, this.Compid);
...
LoadData_Old(stateCode:string,districtCode:string,cityCode:string)
{
  this.Compid ="BLCS";
  this.service.GetStatusofHouses_CompWise("BLCS").subscribe(result=>{
   this.HouseInvolved11=result[0].Housesinvolved;
  ...
  this.FundsDisbursed_in_Houses11=result[0].FundsDisbursed_in_Houses;
  ...
  //this.FundsDisbursed_in_Houses6=result[5].FundsDisbursed_in_Houses;
...
this.display='block';  
 ...
 ResetVariables_CLSS()
 {
  ...
  this.HouseInvolved21_ISSR_15 = 0;
  this.HouseInvolved2_15AHP
  this.FundsDisbursed_in_Houses2_15AHP    
  this.Houses_Grounded2_15AHP
  this.Houses_Completed2_15AHP= 0;
  this.HousesOccupied2_15AHP= 0;
  this.HouseInvolved2BLCS = 0;
  this.FundsDisbursed_in_Houses2BLCS = 0;
...
ResetVariables_JN()
{
  ...
  this.FundsDisbursed_in_Houses6=0; 
  this.Houses_Grounded6 =0;
  this.Houses_Completed6 =0;
  this.HousesOccupied6=0;


  this.THouseInvolvedNew=0; 
  this.TFundsDisbursed_in_Houses=0;
  this.THousesOccupied=0;
  ...
  this.HousesOccupied2=0; 
   this.HousesOccupied2_15AHP =0; 
    this.HousesOccupied2BLCS =0; 
      ...
      //  HouseInvolved114AHP
      //  FundsDisbursed_in_Houses114AHP
      //   Houses_Grounded114AHP
      //    Houses_Completed114AHP
      //     HousesOccupied114AHP
 ...
 // debugger;
  ...
  const checked=$event.target.checked;
    if (checked) {
      ...
      {
        // debugger;
        // document.getElementById("chkOne").removeAttribute('checked');
        // document.getElementById("chkTwo").removeAttribute('checked');
        // document.getElementById("chkThree").removeAttribute('checked');
        // document.getElementById("chkFour").removeAttribute('checked');
   ...
   // alert(data); 
    ...
    this.BindGetStatus1(this.stateCodes, this.districtCodes, this.cityCodes, data);
...
this.Header="Status of Houses Sanctioned in Respective Years under PMAY(U)";
    ...
    // compId ="JnNURM";
     //this.clearVar(); 
      if (compId == null)
          ...
          this.Houses_Grounded114AHP =this.Houses_Grounded1 +this.Houses_GroundedJN1 ;
          ...
          this.Houses_Completed1 = this.Houses_Completed1 + this.Houses_CompletedJN1; 
          try {
        ...
        //-- BLCS Start------------------------------------------------------ 
          ...
          this.Houses_Grounded1B14 =this.Houses_Grounded1B14 ;
          ...
          this.Houses_Completed1B14 = this.Houses_Completed1B14 ; 
          try {
        ...
        this.HousesOccupied1  =this.HousesOccupied1 + this.HousesOccupiedJN1;
      ...
      //--------------------------------------2014-15 End------------------------------------------------------
        ...
        //alert(this.FundsDisbursed_in_Houses2);
       ...
       //-----------------BLCS Start----------------------------------------
           ...
           //   alert(this.FundsDisbursed_in_Houses2BLCS);
            ...
            //  alert(this.Houses_Grounded2BLCS);
             ...
             // alert(this.Houses_Completed2BLCS);
           ...
           //   alert(this.HousesOccupied2BLCS);
              //---------------------BLCS END----------------------------------
  ...
  //----------------------------------------------------------------------
        ...
        this.service.sp_GetHousesStatusFor2018_19(stateCode,districtCode,cityCode,'BLCS').subscribe(result_18_19BLCS=>{
          ...
          this.service.sp_GetHousesStatus_ISSR_2018_19(stateCode,districtCode,cityCode,compId).subscribe(resultISSR_18_19=>{
  ...
  //-------------------------------------------
   ...
   this.service.sp_GetHousesStatus_ISSR_2019_20(stateCode,districtCode,cityCode,compId).subscribe(resultISSR_19_20=>{
  ...
  //TFundsDisbursed_in_Houses11 TotalFundsDisbursedAHP1 TFundsDisbursed_in_Houses1_ISSR BeneCLSS_Total

//  THouseInvolved11 =HouseInvolved01  +HouseInvolved11  +HouseInvolved_21 +HouseInvolved_31 + HouseInvolved_41 +HouseInvolved_51  
  ...
  BindGetStatus1(stateCode:string,districtCode:string,cityCode:string,compId:string)
  {
    alert(compId);
  //  this.clearVar(); 
    this.Bene2014_15_CLSS =0;
     ...
     this.Houses_ISSRCompleted1=0;
      ...
      this.Houses_GroundedJNG=0;
        ...
        this.service.GetCLSS_Houses_VerticalWise(stateCode).subscribe(result_CLSSAll=>{
            ...
            localStorage.setItem('Bene14', this.Bene2014_15_CLSS.toString()); 
            localStorage.setItem('Bene15', this.Bene2015_16_CLSS.toString()); 
            localStorage.setItem('Bene16', this.Bene2016_17_CLSS.toString()); 
            localStorage.setItem('Bene17', this.Bene2017_18_CLSS.toString()); 
            localStorage.setItem('Bene18', this.Bene2018_19_CLSS.toString()); 
            localStorage.setItem('Bene19', this.Bene2019_20_CLSS.toString()); 
        });
        //AHP  
        ...
        this.service.sp_GetHousesStatusFor2014_15(stateCode,districtCode,cityCode,'AHP').subscribe(result_14_15AHP=>{
             ...
             // this.Houses_Grounded114AHP =this.Houses_Grounded1 +this.Houses_GroundedJN1 ;
              ...
              this.Houses_Grounded114AHP != null ? this.Houses_Grounded114AHP : 0;
              this.FundsDisbursed_in_Houses114AHP != null ? this.FundsDisbursed_in_Houses114AHP : 0;
              this.HouseInvolved114AHP != null ? this.HouseInvolved114AHP : 0;


              localStorage.setItem('AHPi14', this.HouseInvolved114AHP.toString()); 
              localStorage.setItem('AHPd14', this.FundsDisbursed_in_Houses114AHP.toString()); 
              localStorage.setItem('AHPg14', this.Houses_Grounded114AHP.toString()); 
              localStorage.setItem('AHPc14', this.Houses_Completed114AHP.toString()); 
              localStorage.setItem('AHPo14', this.HousesOccupied114AHP.toString()); 
        });
      ...
      this.HouseInvolved1B14 != null ? this.HouseInvolved1B14 : 0;
      this.FundsDisbursed_in_Houses1B14 != null ? this.FundsDisbursed_in_Houses1B14 : 0;
 


          localStorage.setItem('BLCSi14', this.HouseInvolved1B14.toString()); 
          localStorage.setItem('BLCSd14', this.FundsDisbursed_in_Houses1B14.toString()); 
          localStorage.setItem('BLCSg14', this.Houses_Grounded1B14.toString()); 
          localStorage.setItem('BLCSc14', this.Houses_Completed1B14.toString()); 
          localStorage.setItem('BLCSo14', this.HousesOccupied1B14.toString()); 
        });

        // JN
        this.service.sp_GetHousesStatusForVertical(stateCode).subscribe(resultJN=>{          
         // this.classall.number1=resultJN[0].Houses_Grounded;     
          //this.classall.number=resultJN[0].Houses_Completed;
          // <<<<<<<<<<<<<<<2014-15  FOR JNNURM >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>           
          this.Houses_GroundedJNG  !=null ?  this.Houses_GroundedJNG : "0";

          this.Houses_GroundedJNG=resultJN[0].Houses_Grounded;
          this.Houses_CompletedJNC=resultJN[0].Houses_Completed;
          this.HousesOccupiedJNO=resultJN[0].HousesOccupied;  
        //  localStorage.setItem('userName', this.Houses_Grounded1new.toString()); 


        localStorage.setItem('JNg14', this.Houses_GroundedJNG.toString());
        localStorage.setItem('JNc14', this.Houses_CompletedJNC.toString());
        localStorage.setItem('JNo14', this.HousesOccupiedJNO.toString()); 
        });
    ...
    //const value1=localStorage.getItem('userName');

    this.HouseInvolved1ISSR != null ? this.HouseInvolved1ISSR : 0;
    this.FundsDisbursed_ISSR_Houses1 != null ? this.FundsDisbursed_ISSR_Houses1 : 0;

     
    localStorage.setItem('ISSRi14', this.HouseInvolved1ISSR.toString());
    localStorage.setItem('ISSRd14', this.FundsDisbursed_ISSR_Houses1.toString());
    localStorage.setItem('ISSRg14', this.Houses_ISSRGrounded1.toString());
    localStorage.setItem('ISSRc14', this.Houses_ISSRCompleted1.toString());
    localStorage.setItem('ISSRo14', this.Houses_ISSROccupied1.toString());
      ...
      //   this.Bene2014_15_CLSS =0;
        ...
        if (compId=="JnNURM")
        {
          localStorage.removeItem('BLCSd14');
         ...
         this.HouseInvolved1 = 
         parseInt(localStorage.getItem('BLCSd14')) +
         parseInt(localStorage.getItem('AHPd14'))  +
         parseInt(localStorage.getItem('Bene14'))  +
         parseInt(localStorage.getItem('ISSRd14'));
         ...
         this.Houses_Grounded1 = parseInt(localStorage.getItem('JNg14'))  +
         parseInt(localStorage.getItem('BLCSg14'))+ parseInt(localStorage.getItem('AHPg14')) +
         parseInt(localStorage.getItem('Bene14')) + parseInt(localStorage.getItem('ISSRg14'));

         this.Houses_Completed1 = parseInt(localStorage.getItem('JNc14'))  +
         parseInt(localStorage.getItem('BLCSc14'))+ parseInt(localStorage.getItem('AHPc14')) +
         parseInt(localStorage.getItem('Bene14')) + parseInt(localStorage.getItem('ISSRc14'));

         this.HousesOccupied1 = parseInt(localStorage.getItem('JNo14'))  +
         parseInt(localStorage.getItem('BLCSo14'))+ parseInt(localStorage.getItem('AHPo14')) +
         parseInt(localStorage.getItem('Bene14')) + parseInt(localStorage.getItem('ISSRo14'));
         //--------------------------------------2014-15------------------------------------------------------        //  this.HouseInvolved1=   this.HouseInvolved114AHP +  this.HouseInvolved1B14 + this.Bene2014_15_CLSS + this.HouseInvolved1ISSR;// +this.Bene2014_15_CLSS;
        //  this.FundsDisbursed_in_Houses1 = this.FundsDisbursed_in_Houses114AHP + this.FundsDisbursed_in_Houses1B14+ this.Bene2014_15_CLSS +   this.FundsDisbursed_ISSR_Houses1;
        //  this.Houses_Grounded1 = this.Houses_Grounded114AHP + this.Houses_Grounded1B14 + this.Bene2014_15_CLSS +  this.Houses_GroundedJNG+  this.Houses_ISSRGrounded1;
        //  this.Houses_Completed1 = this.Houses_Completed114AHP + this.Houses_Completed1B14 +  this.Bene2014_15_CLSS +  this.Houses_CompletedJNC + this.Houses_ISSRCompleted1;
        //  this.HousesOccupied1 = this.HousesOccupied1B14  +this.HousesOccupied114AHP + this.Bene2014_15_CLSS +  this.HousesOccupiedJNO+  this.Houses_ISSROccupied1;
        ...
        this.service.sp_GetHousesStatusFor2015_16(stateCode,districtCode,cityCode,'AHP').subscribe(result_15_16AHP=>{
          ...
          localStorage.setItem('AHPi15', this.HouseInvolved2_15AHP.toString()); 
          localStorage.setItem('AHPd15', this.FundsDisbursed_in_Houses2_15AHP.toString()); 
          localStorage.setItem('AHPg15', this.Houses_Grounded2_15AHP.toString()); 
          localStorage.setItem('AHPc15', this.Houses_Completed2_15AHP.toString()); 
          localStorage.setItem('AHPo15', this.HousesOccupied2_15AHP.toString()); 
        ...
        this.service.sp_GetHousesStatusFor2015_16(stateCode,districtCode,cityCode,'BLCS').subscribe(result_15_16BLCS=>{
          ...
          localStorage.setItem('BLCSi15', this.HouseInvolved2_15AHP.toString()); 
          localStorage.setItem('BLCSd15', this.FundsDisbursed_in_Houses2_15AHP.toString()); 
          localStorage.setItem('BLCSg15', this.Houses_Grounded2_15AHP.toString()); 
          localStorage.setItem('BLCSc15', this.Houses_Completed2_15AHP.toString()); 
          localStorage.setItem('BLCSo15', this.HousesOccupied2_15AHP.toString()); 
          //---------------------BLCS END----------------------------------
  ...
  GetFilterData (stateCodes, districtCodes, cityCodes, Compid)
  {
  //  alert('abc');
...
this.service.GetStatusofHouses_CompWiseNew(stateCodes,districtCodes ,cityCodes,"BLCS","2014-15").subscribe(result_BLCS14=>{
      try { 
      this.HouseInvolved01=result_BLCS14[0].Housesinvolved;
      this.FundsDisbursed_in_Houses01 = result_BLCS14[0].FundsDisbursed_in_Houses;
      this.Houses_Grounded01 = result_BLCS14[0].Houses_Grounded;
      this.Houses_Completed01 = result_BLCS14[0].Houses_Completed;
      this.HousesOccupied01 = result_BLCS14[0].HousesOccupied;
      }
      catch{}
      finally{}
    });
      ...
      this.service.GetStatusofHouses_CompWiseNew(stateCodes,districtCodes,cityCodes,"BLCS","2015-16").subscribe(result_BLCS=>{
        try { 
          this.HouseInvolved11=result_BLCS[0].Housesinvolved;
        this.FundsDisbursed_in_Houses11 = result_BLCS[0].FundsDisbursed_in_Houses;
        this.Houses_Grounded11 = result_BLCS[0].Houses_Grounded;
        this.Houses_Completed11 = result_BLCS[0].Houses_Completed;
        this.HousesOccupied11 = result_BLCS[0].HousesOccupied;
      }
      catch{}
      finally{}
    });
       
        this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"BLCS","2016-17").subscribe(result_BLCS16=>{
          try { 
          this.HouseInvolved_21=result_BLCS16[0].Housesinvolved;
          this.FundsDisbursed_in_Houses_21 = result_BLCS16[0].FundsDisbursed_in_Houses;
          this.Houses_Grounded_21 = result_BLCS16[0].Houses_Grounded;
          this.Houses_Completed_21 = result_BLCS16[0].Houses_Completed;
          this.HousesOccupied_21 = result_BLCS16[0].HousesOccupied;
        }
        catch{}
        finally{}
      });
    this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"BLCS","2017-18").subscribe(result_BLCS=>{
      try { 
      
            this.HouseInvolved_31=result_BLCS[0].Housesinvolved;
            this.FundsDisbursed_in_Houses_31 = result_BLCS[0].FundsDisbursed_in_Houses;
            this.Houses_Grounded_31 = result_BLCS[0].Houses_Grounded;
            this.Houses_Completed_31 = result_BLCS[0].Houses_Completed;
            this.HousesOccupied_31 = result_BLCS[0].HousesOccupied;
          }
          catch{}
          finally{}
        });
    this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"BLCS","2018-19").subscribe(result_BLCS=>{
      try { 
      
      this.HouseInvolved_41=result_BLCS[0].Housesinvolved;
              this.FundsDisbursed_in_Houses_41 = result_BLCS[0].FundsDisbursed_in_Houses;
              this.Houses_Grounded_41 = result_BLCS[0].Houses_Grounded;
              this.Houses_Completed_41 = result_BLCS[0].Houses_Completed;
              this.HousesOccupied_41= result_BLCS[0].HousesOccupied;
            }
            catch{}
            finally{}
          });
    this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"BLCS","2019-20").subscribe(result_BLCS=>{
      try { 
        this.HouseInvolved_51=result_BLCS[0].Housesinvolved;
                this.FundsDisbursed_in_Houses_51 = result_BLCS[0].FundsDisbursed_in_Houses;
                this.Houses_Grounded_51 = result_BLCS[0].Houses_Grounded;
                this.Houses_Completed_51 = result_BLCS[0].Houses_Completed;
                this.HousesOccupied_51= result_BLCS[0].HousesOccupied;
                ...
                this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"AHP","2014-15").subscribe(result_AHP=>{
                  try { 
                    this.HouseInvolved01_AHP=result_AHP[0].Housesinvolved;
                  this.FundsDisbursed_in_Houses01_AHP = result_AHP[0].FundsDisbursed_in_Houses;
                  this.Houses_Grounded01_AHP = result_AHP[0].Houses_Grounded;
                  this.Houses_Completed01_AHP = result_AHP[0].Houses_Completed;
                  this.HousesOccupied01_AHP = result_AHP[0].HousesOccupied;                     
                }
                catch{}
                finally{}
              });            
                  this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"AHP","2015-16").subscribe(result_AHP15=>{
                    try { 
                      this.HouseInvolved11_AHP=result_AHP15[0].Housesinvolved;
                    this.FundsDisbursed_in_Houses11_AHP = result_AHP15[0].FundsDisbursed_in_Houses;
                    this.Houses_Grounded11_AHP = result_AHP15[0].Houses_Grounded;
                    this.Houses_Completed11_AHP = result_AHP15[0].Houses_Completed;
                    this.HousesOccupied11_AHP = result_AHP15[0].HousesOccupied;
                  }
                  catch{}
                  finally{}
                });
                  
                    this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"AHP","2016-17").subscribe(result_AHP16=>{
                      try { 
                        this.HouseInvolved21_AHP=result_AHP16[0].Housesinvolved;
                      this.FundsDisbursed_in_Houses21_AHP = result_AHP16[0].FundsDisbursed_in_Houses;
                      this.Houses_Grounded21_AHP = result_AHP16[0].Houses_Grounded;
                      this.Houses_Completed21_AHP = result_AHP16[0].Houses_Completed;
                      this.HousesOccupied21_AHP = result_AHP16[0].HousesOccupied;
                    }
                    catch{}
                    finally{}

                  });
                      this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"AHP","2017-18").subscribe(result_AHP=>{
                        try { 
                        this.HouseInvolved31_AHP=result_AHP[0].Housesinvolved;
                        this.FundsDisbursed_in_Houses31_AHP = result_AHP[0].FundsDisbursed_in_Houses;
                        this.Houses_Grounded31_AHP = result_AHP[0].Houses_Grounded;
                        this.Houses_Completed31_AHP = result_AHP[0].Houses_Completed;
                        this.HousesOccupied31_AHP = result_AHP[0].HousesOccupied;
                      }
                      catch{}
                      finally{}
                    });
                      
                        this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"AHP","2018-19").subscribe(result_AHP18=>{
                          try { 
                            this.HouseInvolved41_AHP=result_AHP18[0].Housesinvolved;
                          this.FundsDisbursed_in_Houses41_AHP = result_AHP18[0].FundsDisbursed_in_Houses;
                          this.Houses_Grounded41_AHP = result_AHP18[0].Houses_Grounded;
                          this.Houses_Completed41_AHP = result_AHP18[0].Houses_Completed;
                          this.HousesOccupied41_AHP = result_AHP18[0].HousesOccupied;
                        }
                        catch{}
                        finally{}
                      });
                          this.service.GetStatusofHouses_CompWiseNew(this.stateCodes,this.districtCodes ,this.cityCodes,"AHP","2019-20").subscribe(result_AHP19=>{
                            try { 
                            this.HouseInvolved51_AHP=result_AHP19[0].Housesinvolved;
                            this.FundsDisbursed_in_Houses51_AHP = result_AHP19[0].FundsDisbursed_in_Houses;
                            this.Houses_Grounded51_AHP = result_AHP19[0].Houses_Grounded;
                            this.Houses_Completed51_AHP = result_AHP19[0].Houses_Completed;
                            this.HousesOccupied51_AHP = result_AHP19[0].HousesOccupied;
                          }
                          catch{}
                          finally{}
                        });
                          // this.THouseInvolved_AHP1  =this.HouseInvolved01_AHP + this.HouseInvolved11_AHP+ this.HouseInvolved21_AHP+ this.HouseInvolved31_AHP+ this.HouseInvolved41_AHP+ this.HouseInvolved51_AHP; 
                          // this.TotalFundsDisbursedAHP1 =this.FundsDisbursed_in_Houses01_AHP +this.FundsDisbursed_in_Houses11_AHP +this.FundsDisbursed_in_Houses21_AHP + this.FundsDisbursed_in_Houses31_AHP +this.FundsDisbursed_in_Houses41_AHP +this.FundsDisbursed_in_Houses51_AHP;
                          // this.THouses_Grounded_AHP1 = this.Houses_Grounded01_AHP + this.Houses_Grounded11_AHP + this.Houses_Grounded21_AHP + this.Houses_Grounded31_AHP + this.Houses_Grounded41_AHP + this.Houses_Grounded51_AHP;
                          // this.THouses_Completed_AHP1= this.Houses_Completed01_AHP +this.Houses_Completed11_AHP +this.Houses_Completed21_AHP +this.Houses_Completed31_AHP +this.Houses_Completed41_AHP +this.Houses_Completed51_AHP;
                          // this.THousesOccupied_AHP1 = this.HousesOccupied01_AHP +this.HousesOccupied11_AHP +this.HousesOccupied21_AHP +this.HousesOccupied31_AHP +this.HousesOccupied41_AHP +this.HousesOccupied51_AHP;


                          this.service.sp_GetHousesStatus_ISSR_FinYearWise(this.stateCodes,this.districtCodes ,this.cityCodes,"ISSR","2014-15").subscribe(result_ISSR0=>{
                            try { 
                              this.HouseInvolved01_ISSR=result_ISSR0[0].Housesinvolved;
                            this.FundsDisbursed_in_Houses01_ISSR=result_ISSR0[0].FundsDisbursed_in_Houses;
                            this.Houses_Grounded01_ISSR=result_ISSR0[0].Houses_Grounded;
                            this.Houses_Completed01_ISSR=result_ISSR0[0].Houses_Completed;
                            this.HousesOccupied01_ISSR=result_ISSR0[0].HousesOccupied; 
                          }
                          catch{}
                          finally{}
                        });
                          this.service.sp_GetHousesStatus_ISSR_FinYearWise(this.stateCodes,this.districtCodes ,this.cityCodes,"ISSR","2015-16").subscribe(result_ISSR15=>{
                            try { 
                              this.HouseInvolved11_ISSR=result_ISSR15[0].Housesinvolved;
                            this.FundsDisbursed_in_Houses11_ISSR=result_ISSR15[0].FundsDisbursed_in_Houses;
                            this.Houses_Grounded11_ISSR=result_ISSR15[0].Houses_Grounded;
                            this.Houses_Completed11_ISSR=result_ISSR15[0].Houses_Completed;
                            this.HousesOccupied11_ISSR=result_ISSR15[0].HousesOccupied; 
                          }
                          catch{}
                          finally{}
                        });
                            this.service.sp_GetHousesStatus_ISSR_FinYearWise(this.stateCodes,this.districtCodes ,this.cityCodes,"ISSR","2016-17").subscribe(result_ISSR1=>{
                              try { 
                                this.HouseInvolved12_ISSR=result_ISSR1[0].Housesinvolved;
                              this.FundsDisbursed_in_Houses12_ISSR=result_ISSR1[0].FundsDisbursed_in_Houses;
                              this.Houses_Grounded12_ISSR=result_ISSR1[0].Houses_Grounded;
                              this.Houses_Completed12_ISSR=result_ISSR1[0].Houses_Completed;
                              this.HousesOccupied12_ISSR=result_ISSR1[0].HousesOccupied;  
                            }
                            catch{}
                            finally{}
                          });
                              this.service.sp_GetHousesStatus_ISSR_FinYearWise(this.stateCodes,this.districtCodes ,this.cityCodes,"ISSR","2017-18").subscribe(result_ISSR3=>{
                                try { 
                                this.HouseInvolved13_ISSR=result_ISSR3[0].Housesinvolved;
                                this.FundsDisbursed_in_Houses13_ISSR=result_ISSR3[0].FundsDisbursed_in_Houses;
                                this.Houses_Grounded13_ISSR=result_ISSR3[0].Houses_Grounded;
                                this.Houses_Completed13_ISSR=result_ISSR3[0].Houses_Completed;
                                this.HousesOccupied13_ISSR=result_ISSR3[0].HousesOccupied; 
                              }
                              catch{}
                              finally{}
                            });       
                                this.service.sp_GetHousesStatus_ISSR_FinYearWise(this.stateCodes,this.districtCodes ,this.cityCodes,"ISSR","2018-19").subscribe(result_ISSR4=>{
                                  try { 
                                    this.HouseInvolved14_ISSR=result_ISSR4[0].Housesinvolved;
                                  this.FundsDisbursed_in_Houses14_ISSR=result_ISSR4[0].FundsDisbursed_in_Houses;
                                  this.Houses_Grounded14_ISSR=result_ISSR4[0].Houses_Grounded;
                                  this.Houses_Completed14_ISSR=result_ISSR4[0].Houses_Completed;
                                  this.HousesOccupied14_ISSR=result_ISSR4[0].HousesOccupied; 
                                }
                                catch{}
                                finally{}
                              });         
            ...
            this.service.sp_GetHousesStatus_ISSR_FinYearWise(this.stateCodes,this.districtCodes ,this.cityCodes,"ISSR","2019-20").subscribe(result_ISSR5=>{
              try { 
                this.HouseInvolved15_ISSR=result_ISSR5[0].Housesinvolved;
              this.FundsDisbursed_in_Houses15_ISSR=result_ISSR5[0].FundsDisbursed_in_Houses;
              this.Houses_Grounded15_ISSR=result_ISSR5[0].Houses_Grounded;
              this.Houses_Completed15_ISSR=result_ISSR5[0].Houses_Completed;
              this.HousesOccupied15_ISSR=result_ISSR5[0].HousesOccupied; 
            }
            catch{}
            finally{}
          });
              ...
              this.service.GetCLSS_Houses_VerticalWise(this.stateCodes).subscribe(result_CLSS=>{
                try { 
                ...
                this.BeneCLSS_Total =this.Bene2014_15_CLSS +this.Bene2015_16_CLSS + this.Bene2016_17_CLSS + this.Bene2017_18_CLSS +this.Bene2018_19_CLSS + this.Bene2019_20_CLSS;
              }
              catch{}
              finally{}
            });
              this.HouseInvolved311 = this.HouseInvolved_21 +this.HouseInvolved21_AHP  +this.HouseInvolved12_ISSR +this.Bene2016_17_CLSS;
              this.HouseInvolved2new =this.HouseInvolved11 +  this.HouseInvolved11_AHP; //+ this.Bene2015_16;
              this.HouseInvolved411 =  this.HouseInvolved_31 +this.HouseInvolved31_AHP  +this.HouseInvolved13_ISSR +this.Bene2017_18_CLSS;
              this.HouseInvolved511 =  this.HouseInvolved_41 +this.HouseInvolved41_AHP  +this.HouseInvolved14_ISSR +this.Bene2018_19_CLSS;

              // alert(this.HouseInvolved_51);
              // alert(this.HouseInvolved51_AHP);
              // alert(this.HouseInvolved15_ISSR);
              // alert(this.Bene2019_20_CLSS);

              this.HouseInvolved611 =  this.HouseInvolved_51 +this.HouseInvolved51_AHP  
              +this.HouseInvolved15_ISSR +this.Bene2019_20_CLSS;
              
              this.THouseInvolved = this.HouseInvolved6 +this.HouseInvolved5+ this.HouseInvolved4 +this.HouseInvolved3 +this.HouseInvolved2new +this.HouseInvolved1;

                this.service.sp_GetHousesStatusForVertical(this.stateCodes).subscribe(resultJN1=>{
                  try { 
                    this.Houses_GroundedJNG=resultJN1[0].Houses_Grounded;
                  this.Houses_CompletedJNC=resultJN1[0].Houses_Completed;
                this.HousesOccupiedJNO=resultJN1[0].HousesOccupied;
              }
              catch{}
              finally{}
            });
    ...
    //          alert('abc0');
            ...
            //  this.THouseInvolved11 = this.HouseInvolved01 + this.HouseInvolved11 + this.HouseInvolved_21 +this.HouseInvolved_31 + this.HouseInvolved_41 + this.HouseInvolved_51;
              this.TFundsDisbursed_in_Houses11 = this.FundsDisbursed_in_Houses01 +  this.FundsDisbursed_in_Houses11 + this.FundsDisbursed_in_Houses_21 +  this.FundsDisbursed_in_Houses3 + this.FundsDisbursed_in_Houses_41  +this.FundsDisbursed_in_Houses_51;
              this.THouses_Grounded11 =this.Houses_Grounded01 +this.Houses_Grounded11 +this.Houses_Grounded_21 +this.Houses_Grounded_31 +this.Houses_Grounded_41 +this.Houses_Grounded_51;
              this.THouses_Completed11 = this.Houses_Completed01 + this.Houses_Completed11 +this.Houses_Completed_21 +this.Houses_Completed_31 +this.Houses_Completed_41 +this.Houses_Completed_51;
              this.THousesOccupied11   = this.HousesOccupied01 +this.HousesOccupied11 +this.HousesOccupied_21 +this.HousesOccupied_31 +this.HousesOccupied_41 +this.HousesOccupied_51;
            
  
                this.THouseInvolved1_ISSR = this.HouseInvolved01_ISSR +this.HouseInvolved11_ISSR +this.HouseInvolved12_ISSR +this.HouseInvolved13_ISSR +this.HouseInvolved14_ISSR +this.HouseInvolved15_ISSR;        
                this.TFundsDisbursed_in_Houses1_ISSR =this.FundsDisbursed_in_Houses01_ISSR +this.FundsDisbursed_in_Houses11_ISSR +this.FundsDisbursed_in_Houses12_ISSR +this.FundsDisbursed_in_Houses13_ISSR +this.FundsDisbursed_in_Houses14_ISSR +this.FundsDisbursed_in_Houses15_ISSR;
                this.THouses_Grounded1_ISSR =this.Houses_Grounded01_ISSR +this.Houses_Grounded11_ISSR +this.Houses_Grounded12_ISSR +this.Houses_Grounded13_ISSR +this.Houses_Grounded14_ISSR +this.Houses_Grounded15_ISSR;
                this.THouses_Completed1_ISSR =this.Houses_Completed01_ISSR +this.Houses_Completed11_ISSR +this.Houses_Completed12_ISSR +this.Houses_Completed13_ISSR +this.Houses_Completed14_ISSR +this.Houses_Completed15_ISSR;
                this.THousesOccupied1_ISSR =this.HousesOccupied01_ISSR +this.HousesOccupied11_ISSR +this.HousesOccupied12_ISSR +this.HousesOccupied13_ISSR +this.HousesOccupied14_ISSR +this.HousesOccupied15_ISSR;
               // alert('abc1');
    ...
    debugger;
      ...
      this.service.GetFinancialPMAY_Data(stateCodes,districtCodes ,cityCodes,"AHP","2014-15").subscribe(result_FinAH14=>{
        ...
        this.service.GetFinancialPMAY_Data(stateCodes,districtCodes ,cityCodes,"AHP","2015-16").subscribe(result_FinAH15=>{
          ...
          this.Total15AHP  =  this.First14AHP +   this.Second14AHP + this.Third14AHP;
...
this.UC_Received17ISS= 0;
             ...
             //this.PC18AHP        
              ...
              this.CAI14 =this.CAI_BLC14 + this.CAI14AHP +this.CAI14ISS ;
              ...
              this.CAI15 =this.CAI15BLC + this.CAI15AHP +this.CAI15ISS ;
              ...
              this.CAI16 =this.CAI16BLC + this.CAI16AHP +this.CAI16ISS ;
              ...
              this.CAI17 =this.CAI17 + this.CAI17AHP +this.CAI17ISS ;
              ...
              this.CAI18 =this.CAI18 + this.CAI18AHP +this.CAI18ISS ;
              this.First18 = this.First18 + this.First18AHP +this.First18ISS  +this.Sub2017_18_CL;
              ...
              this.CAI19 = this.CAI19 + this.CAI19AHP + this.CAI19ISS ;
              this.First19 = this.First19 + this.First19AHP + this.First19ISS  +this.Sub2018_19_CL;
