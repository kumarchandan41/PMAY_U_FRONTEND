...
@Component({
  selector: 'app-ata-glance3',
  templateUrl: './ata-glance3.component.html',
  styleUrls: ['./ata-glance3.component.css']
})
export class AtaGlance3Component implements OnInit {
 // StateDetails : States[];
...
//  constructor(private router:Router, public service: BuildingServiceService) {
    this.division ="HFA-3";
     //this.division ="HFA-1";
     this.stValue="0";
     this.distValue="0";
...
//    this.NoPApprovedJN=result.NoOfprojApproved;
      ...
      // this.Grounded_JN=result.Grounded;
      // this.Completed_JN=result.Completed;
    ...
    //  CLSSCityWiseReportPMayListNew
     ...
     this.CAS_Total =  this.CSRay + this.SubsidyAmtCr  +this.CSISSR + this.CSAHP + this.ProjCostBLCS ;
 ...
 //   alert(DisttCode);
  ...
  this.NoofBene =0
   ...
   // this.HOcc_BLCS=14;
    ...
    this.service.HFA_JNNURN_AtAGlanceNew(this.stateCodes,this.districtCodes,this.cityCodes,this.division);
  ...
  this.service.HFA_JNNURN_AtAGlanceNew(this.stateCodes,this.districtCodes,this.cityCodes,this.division);
      ...
      if (result.NoOfprojApproved !=null &&  result.NoOfprojApproved !=0 )
      {
       // alert(result.NoOfprojApproved);
        ...
        this.Grounded_JN=result.Grounded;
        this.Completed_JN=result.Completed;
        this.Occupied_JN=result.Occupied;
        this.HS_JN=result.HousesSanctioned;
        this.CARel_JN=result.CentralAssisRel;
        this.CShare_JN=result.CentralShare;
      }
...
this.HO_Total =indianFormat(this.HO_Total);
  ...
  BindGroundedGraph(stateCode,DisttCode,cityCode)
  {
   ...
   {
    alert('aa');
     this.router.navigate(['/dashboardhfa3']);
   }
