...
import { Charts, District, States, City, FinDetails, CompMaster } from 'src/app/financeReport/model/chart';
...
export class GraphsComponent implements OnInit {
  ...
  CA_Released_Nw: any;
  UC_RecdNew_Ch: any;
  lstHFACodes: import("src/app/financeReport/model/chart").getHFACodes[];
