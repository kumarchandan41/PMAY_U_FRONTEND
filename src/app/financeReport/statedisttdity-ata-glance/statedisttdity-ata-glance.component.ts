...
//     this.isCity = false;
//     this.isDist = false;
//     this.service.Get_StateDisttCityAtaGlance(this.stateCodes, this.districtCodes, this.cityCodes, this.Division, this.Comp,this.pageNumber).subscribe(result_Fin14 => {
//       this.lstCriticalData = result_Fin14;
//     })
//     this.islabel = "block";
//   }
