...
//----------------Test Table---------------------------------------------------
     ...
     {
          // new
          return this.http.get<Excel_clssMasterNew[]>(this.url + "GetExcelClssMaster_Details");
     }
     ...
     {
          return this.http.get<ExcelSheet[]>(this.url + "GetExcelJNNURM_Details");
     }
     //--------------------------------------- CLSS
...
//--------------------------- new Data Start
    ...
    {  
     ...
     {
          return this.http.get<Excel_clssMasterNew[]>(this.url + "GetExcelPMAYDetails");//.toPromise().then(result=>this.ChartDetail= result as Charts);
     }
//--------------------------- new Data End
    ...
    // string stateCode, string , string  , string Cid ,string Div
     ...
     {
          const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json'}) };  
          return this.http.put<boolean>(this.url + '/UpdateUserDetails/',  
          data, httpOptions);  
     }
}